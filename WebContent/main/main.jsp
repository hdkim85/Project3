		...
		<div class="main_contents">
			<div class="main_con_left">
				...
				<div class="login_box">
					...
					<form action="../member/LoginProcess.jsp">
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<tr>
							...
							<td><input type="text" name="user_id" value="<%=user==null ? "" : user%>" 
							class="login_input" /></td>
							<td rowspan="2">
							
							<input type="image" src="../images/login_btn01.gif" alt="로그인" />
							</a>
							</td>
						</tr>
						<tr>
							<th><img src="../images/login_tit02.gif" alt="패스워드" /></th>
							<td><input type="pass" name="user_pw" value="" class="login_input" /></td>
						</tr>
					</table>
					<p>
