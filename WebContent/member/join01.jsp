	...
	<script>
		...
		function checkValidate(){
			...
			if(inputs[0].checked==false){
				alert("이용약관에 동의하지 않으면 회원가입할 수 없습니다.");	
				return false;
			}
			else{
			...
			request.getRequestDispatcher("join02.jsp")
			--%>
	...
	<div id="wrap">
		...
		<div class="contents_box">
			...
			<div class="right_contents">
				...
				<form action="join02.jsp" onsubmit="return checkValidate();" method="post">
				<p style="text-align:center; margin-bottom:20px;"><input type="checkbox" name="agreement1" value="1">이용약관과 개인정보취급방침에 동의합니다.</p>
				
				<p style="text-align:center; margin-bottom:20px"><input type="image" name="submit" src="../images/btn01.gif"/>&nbsp;&nbsp;<a href="#"><img src="../images/btn02.gif" /></a></p>
				</form>
